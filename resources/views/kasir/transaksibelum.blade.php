          ...
          <div class="card">
              <div class="card-body">
                  ...
                  <div class="section-body" >
                    <div class="row">
                        <div class="col-12 ">
                                <table class="table table-stiped table-transaksi">
                                    <thead>
                                        <th>Kode</th>
                                        <th>Nama</th>
                                        <th>Harga</th>
      ...
      <script>
        ...
        $(function () {
            ...
            table = $('.table-transaksi').DataTable({
                ...
                autoWidth: false,
                ajax: {
                    url: '{{ route('belumtransaksi.data', $transaksis->id_transaksi) }}',
                },
                columns: [
                    {data: 'kode_item'},
                    {data: 'nama_item'},
    ...
    $(document).on('submit','form', function (event){
        event.preventDefault();
          ...
          success: function(res,status){
              window.location = '{{ route('transaksi.selesaib',$transaksis->id_transaksi) }}'
      }, error : function (xhr){
        Swal.fire({
                    position: 'center',
                    icon: 'warning',
