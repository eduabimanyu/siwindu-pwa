 <!-- Main Content -->
 @extends('layouts.app')
 @section('tittle', 'Jenis Pembayaran Tunai')
            ...
            <div class="row">
                <div class="col-12 ">
                    <div class="card" id="tunai">
                      <div class="card-body">
                              <table class="table table-striped" id="tabeltunai">
                                  <thead>
                                      <tr>
...
let filter_wisata = $('#filter_wisata').val()
        ...
        function tunai() {
            ...
            $('#tabeltunai').DataTable({
                responsive: true,
                processing: true,
                serverSide: true,
                autoWidth: false,
                ajax : {
                    url : "{{route('transaksitunai.data')}}",
                    data:  function(d){
