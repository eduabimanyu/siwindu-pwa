 <!-- Main Content -->
 @extends('layouts.app')
 @section('tittle', 'Jenis Pembayaran Transfer Ewallet')
...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>Jenis Pembayaran Ewallet</h1>
        ...
        <div class="section-body">
            <div class="row">
                ...
                <div class="card" >
                  <div class="card-body">
                          <table class="table table-striped" id="tabelewalet">
                              <thead>
                                  <tr>
...
let filter_wisata = $('#filter_wisata').val()
        ...
        function ewalet() {
            ...
            $('#tabelewalet').DataTable({
                responsive: true,
                processing: true,
                serverSide: true,
                autoWidth: false,
                ajax : {
                    url : "{{route('transaksiewalet.data')}}",
                    data:  function(d){
